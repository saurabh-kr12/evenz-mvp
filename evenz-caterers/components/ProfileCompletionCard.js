  ...
  const getCompletionStatus = useCallback(() => {
    ...
    if (!packagesAndCuisinesSaved || (!minMaxGuestsAvailableForEventsFilled && !coverImageUploaded)) {
      return {
        ...
        message: 'Your profile is currently hidden from clients. To start receiving leads, please add at least one Package and define your Cuisines in the "Menu & Cuisines" and "Guests & Services" sections.',
        buttonText: 'Go to Menu & Cuisines',
        buttonLink: '/services/menu',
        bgColor: 'bg-amber-50',
