...
//       const response = await fetch('http://localhost:5000/api/vendor/experience/get-experience', {
//         method: 'GET',
//         headers: {
...
//       } else {
//         // Experience not found, user can add new one
//         setExperience(null);
//       }
//     } catch (error) {
...
//   const handleEdit = () => {
//     setEditing(true);
//     setTempExperience(experience?.experience?.toString() || '');
//     setError('');
//   };
...
//       const response = await fetch('http://localhost:5000/api/vendor/experience/add-experience', {
//         method: 'POST',
//         headers: {
//           'Content-Type': 'application/json',
...
//                 {experience ? formatExperience(experience.experience) : 'No experience added'}
//               </span>
//             </div>

//             {experience && (
//               <p className="text-sm text-gray-500">
//                 Last updated: {new Date(experience.updatedAt || experience.createdAt).toLocaleDateString()}
//               </p>
//             )}
...
//                 ) : (
//                   <>
//                     {experience ? <Save className="w-4 h-4" /> : <Plus className="w-4 h-4" />}
//                     <span>{experience ? 'Update' : 'Add'}</span>
//                   </>
//                 )}
//               </button>
