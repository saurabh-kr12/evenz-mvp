            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
               <div>
                  ...
                  <p className="text-gray-300 text-sm">
                     Manage your catering business, receive bookings, and grow your clientele with Evenz.in's vendor management system.
                  </p>
               </div>
               ...
               <div>
                  ...
                  <ul className="space-y-2 text-sm text-gray-300">
                     <li>Email: info@evenz.in</li>
                     <li>Phone: +1 (800) 123-4567</li>
                     <li>Hours: 9 AM - 6 PM, Monday to Friday</li>
                  </ul>
